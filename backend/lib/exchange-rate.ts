import { db } from './db';
import type { ExchangeRate as DbExchangeRate } from '@prisma/client';
...
function map(r:DbExchangeRate):ExchangeRate{return {id:r.id,usdToYer:Number(r.usdToYer),source:r.source,isAutoUpdateEnabled:r.isAutoUpdateEnabled,updatedBy:r.updatedBy,updatedByName:r.updatedByName,createdAt:r.createdAt,updatedAt:r.updatedAt};}
